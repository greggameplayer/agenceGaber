...
def menuAdministrateur():
    ...
    #Find trip
    trip1 = tkinter.Button(menuAdministrateur, text = 'Trouver un voyage',width=20,overrelief='groove',command= toFrameSeeAllTrips ,bg='grey40',fg="snow")
    trip1.grid(row = 1, column=0)
    #find user 
    findUser = tkinter.Button(menuAdministrateur, text = 'Trouver un client',width=20,overrelief='groove',command= toFrameSeeAllUsers ,bg='grey40',fg="snow")
    findUser.grid(row = 2, column=0)
    #creat a new trip
    creatTrip = tkinter.Button(menuAdministrateur, text = 'Ajouter un voyage',width=20,overrelief='groove',command= toFrameAddTrip ,bg='grey40',fg="snow")
    creatTrip.grid(row = 2, column=0)
    #update trip
    updateTrip = tkinter.Button(menuAdministrateur, text = 'Modifier un voyage',width=20,overrelief='groove',command= toFrameModifTrip ,bg='grey40',fg="snow")
    updateTrip.grid(row = 3, column=0)
    #voidLabel 2
    voidLabel2= tkinter.Label(menuAdministrateur,bg='grey15')
    voidLabel2.grid(row =4)
    #disconnect
    disconnect = tkinter.Button(menuAdministrateur, text = 'Déconnexion', width=10, overrelief='groove', command= disconnect , bg='grey40', fg="snow")
...
def menuClient():
    ...
    voidLabel.grid(row = 1, column = 1)
    #Voir réservation
    seeReservation = tkinter.Button(menuClient, text= 'Voir Mes Réservations', width = 50, overrelief='groove',command= toFrameSeeAllReservations ,bg='grey40',fg="snow")
    seeReservation.grid(row = 1, pady = 1)
    #Voir les voyages 
    findTrip = tkinter.Button(menuClient, text= 'Voir Les Voyages', width = 50, overrelief='groove',command= toFrameSeeAllTrips ,bg='grey40',fg="snow")
    findTrip.grid(row = 2, pady = 1)
    #paiement en attente
    seePaiement = tkinter.Button(menuClient, text= 'Voir Mes Paiements', width = 50, overrelief='groove',command= toFrameSeeAllPayments ,bg='grey40',fg="snow")
